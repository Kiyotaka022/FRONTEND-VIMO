    ...
    return (
      ...
      <button className='ml-auto mr-[10px] block'><FontAwesomeIcon className='fa-2xl' icon={faCircleXmark}  onClick={handleClose} /></button>
                    ...
                    <div className=" inline-block w-[280px] border-2 hover:border-formInputs1   rounded-2xl py-1 px-2">
                            ...
                            <input required type="number" min="0" name='id' value={edit[0]? edit[1].id:null} className="block w-[95%] text-1xl font-sans font-semibold px-3 w-3/4 h-10 py-2 outline-0" placeholder="1,352,2,4"></input>
                    </div>

                    <div className=" inline-block w-[280px] border-2 hover:border-formInputs1  rounded-2xl py-1 px-2">
                            <label className="text-xs font-sans font-semibold ml-3">valor a Abonar</label>
                            <input required type="number" min="0" name='valorAbonado' defaultValue={edit[0]? edit[1].valorAbonado:null} className="block w-[95%] text-1xl font-sans font-semibold px-3 w-3/4 h-10 py-2 outline-0" placeholder="1,352,2,4"></input>
                    </div>


                    <div className=" inline-block w-[280px] border-2 hover:border-formInputs1 rounded-2xl py-1 px-2">
                            <label className="text-xs font-sans font-semibold ml-3">Código del Pedido</label>
                            <input required type="number" min="0" name='idVentaPedido'  defaultValue={edit[0]? edit[1].idVentaPedido:null} className="block w-[95%] text-1xl font-sans font-semibold px-3 w-3/4 h-10 py-2 outline-0" placeholder="1,352,2,4"></input>
                    </div>
